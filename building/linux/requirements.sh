...
sudo apt-get --yes -qq install qtbase5-dev qtdeclarative5-dev libqt5webkit5-dev libsqlite3-dev zip
sudo apt-get --yes -qq install qt5-default qttools5-dev-tools libdb4.8-dev libdb4.8++-dev
