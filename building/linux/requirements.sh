...
sudo apt-get --yes -qq install build-essential libseccomp-dev libcap-dev libtool autotools-dev automake pkg-config libssl-dev libevent-dev libz bsdmainutils git libboost-system-dev libboost-filesystem-dev libqrencode-dev libboost-program-options-dev libboost-test-dev libboost-thread-dev libboost-all-dev libprotobuf-dev protobuf-compiler libminiupnpc-dev libqt5gui5 libqt5core5a libqt5dbus5 qttools5-dev > /dev/null
