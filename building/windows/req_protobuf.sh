...
PATH=/usr/lib/mxe/usr/bin/:/usr/bin:$PATH ./configure --host=i686-w64-mingw32 --prefix=/usr/i686-w64-mingw32 --with-protoc=protoc LDFLAGS='-static'
PATH=/usr/lib/mxe/usr/bin/:/usr/bin:$PATH sudo make CC=i686-w64-mingw32-gcc RANLIB=i686-w64-mingw32-ranlib AR=i686-w64-mingw32-ar
