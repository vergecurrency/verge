...
def build():
    ...
    if args.linux:
        ...
        subprocess.check_call(['./gitian-builder/bin/gbuild', '-j', args.jobs, '-m', args.memory, '--commit', 'verge='+args.commit, '--url', 'verge='+args.url, '../verge/contrib/gitian-descriptors/gitian-linux.yml'])
        subprocess.check_call(['./gitian-builder/bin/gsign', '-p', args.sign_prog, '--signer', args.signer, '--release', args.version+'-linux', '--destination', '../gitian.sigs/', '../verge/contrib/gitian-descriptors/gitian-linux.yml'])
        subprocess.check_call('mv build/out/verge-*.tar.gz build/out/src/verge-*.tar.gz ../verge-binaries/'+args.version, shell=True)

    if args.windows:
        print('\nCompiling ' + args.version + ' Windows')
        subprocess.check_call(['./gitian-builder/bin/gbuild', '-j', args.jobs, '-m', args.memory, '--commit', 'verge='+args.commit, '--url', 'verge='+args.url, '../verge/contrib/gitian-descriptors/gitian-win.yml'])
        subprocess.check_call(['./gitian-builder/bin/gsign', '-p', args.sign_prog, '--signer', args.signer, '--release', args.version+'-win-unsigned', '--destination', '../gitian.sigs/', '../verge/contrib/gitian-descriptors/gitian-win.yml'])
    ...
    if args.macos:
        ...
        subprocess.check_call(['./gitian-builder/bin/gbuild', '-j', args.jobs, '-m', args.memory, '--commit', 'verge='+args.commit, '--url', 'verge='+args.url, '../verge/contrib/gitian-descriptors/gitian-osx.yml'])
        subprocess.check_call(['./gitian-builder/bin/gsign', '-p', args.sign_prog, '--signer', args.signer, '--release', args.version+'-osx-unsigned', '--destination', '../gitian.sigs/', '../verge/contrib/gitian-descriptors/gitian-osx.yml'])
...
def sign():
    ...
    if args.windows:
        ...
        subprocess.check_call(['./gitian-builder/bin/gbuild', '-i', '--commit', 'signature='+args.commit, '../verge/contrib/gitian-descriptors/gitian-win-signer.yml'])
        subprocess.check_call(['./gitian-builder/bin/gsign', '-p', args.sign_prog, '--signer', args.signer, '--release', args.version+'-win-signed', '--destination', '../gitian.sigs/', '../verge/contrib/gitian-descriptors/gitian-win-signer.yml'])
    ...
    if args.macos:
        ...
        subprocess.check_call(['./gitian-builder/bin/gbuild', '-i', '--commit', 'signature='+args.commit, '../verge/contrib/gitian-descriptors/gitian-osx-signer.yml'])
        subprocess.check_call(['./gitian-builder/bin/gsign', '-p', args.sign_prog, '--signer', args.signer, '--release', args.version+'-osx-signed', '--destination', '../gitian.sigs/', '../verge/contrib/gitian-descriptors/gitian-osx-signer.yml'])
...
def verify():
    ...
    subprocess.check_call(['./gitian-builder/bin/gverify', '-v', '-d', '../gitian.sigs/', '-r', args.version+'-linux', '../verge/contrib/gitian-descriptors/gitian-linux.yml'])
    print('\nVerifying v'+args.version+' Windows\n')
    subprocess.check_call(['./gitian-builder/bin/gverify', '-v', '-d', '../gitian.sigs/', '-r', args.version+'-win-unsigned', '../verge/contrib/gitian-descriptors/gitian-win.yml'])
    print('\nVerifying v'+args.version+' MacOS\n')
    subprocess.check_call(['./gitian-builder/bin/gverify', '-v', '-d', '../gitian.sigs/', '-r', args.version+'-osx-unsigned', '../verge/contrib/gitian-descriptors/gitian-osx.yml'])
    print('\nVerifying v'+args.version+' Signed Windows\n')
    subprocess.check_call(['./gitian-builder/bin/gverify', '-v', '-d', '../gitian.sigs/', '-r', args.version+'-win-signed', '../verge/contrib/gitian-descriptors/gitian-win-signer.yml'])
    print('\nVerifying v'+args.version+' Signed MacOS\n')
    subprocess.check_call(['./gitian-builder/bin/gverify', '-v', '-d', '../gitian.sigs/', '-r', args.version+'-osx-signed', '../verge/contrib/gitian-descriptors/gitian-osx-signer.yml'])
