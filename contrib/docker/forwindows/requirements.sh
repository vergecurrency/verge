...
# Use it if you want to install x64 toolchain
apt install --yes g++-mingw-w64-x86-64 mingw-w64-x86-64-dev
# Set the default mingw32 g++ compiler option to posix.
update-alternatives --config x86_64-w64-mingw32-g++

# Use it if you want to install x32 toolchain
# apt install --yes g++-mingw-w64-i686 mingw-w64-i686-dev
# Set the default mingw32 g++ compiler option to posix.
