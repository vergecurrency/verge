...
CMutableTransaction::CMutableTransaction() : nVersion(CTransaction::CURRENT_VERSION), nTime(std::time(nullptr)), nLockTime(0) {}
...
CTransaction::CTransaction() : vin(), vout(), nVersion(CTransaction::CURRENT_VERSION), nTime(std::time(nullptr)), nLockTime(0), hash{}, m_witness_hash{} {}
