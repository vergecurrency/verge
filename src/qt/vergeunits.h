...
#ifndef VERGE_QT_VERGEUNITS_H
#define VERGE_QT_VERGEUNITS_H
...
/** VERGE unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class VERGEUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit VERGEUnits(QObject *parent);
...
typedef VERGEUnits::Unit VERGEUnit;

#endif // VERGE_QT_VERGEUNITS_H
