...
bool CheckTransaction(const CTransaction& tx, CValidationState &state, bool fCheckDuplicateInputs)
{
    ...
    // Verge has never activated witness. Keep old witness-capable peers compatible,
    // but reject any transaction that actually carries witness data.
    if (tx.HasWitness())
        return state.DoS(0, false, REJECT_INVALID, "bad-txns-witness");
