/* src/config/verge-config.h.  Generated from verge-config.h.in by configure.  */
/* src/config/verge-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef VERGE_CONFIG_H

#define VERGE_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/vergecurrency/VERGE/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "VERGE Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "VERGE Core 1.1.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "verge"

/* Define to the home page for this package. */
#define PACKAGE_URL "http://VERGEcurrency.com/"
