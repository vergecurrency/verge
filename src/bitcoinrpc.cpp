...
{ //  name                      function                 safemd  unlocked
  //  ------------------------  -----------------------  ------  --------
    ...
    { "gbc",          		&getblockcount,          true,   false },
    { "getconnectioncount",     &getconnectioncount,     true,   false },
    { "getpeerinfo",            &getpeerinfo,            true,   false },
    { "gpi",            	&getpeerinfo,            true,   false },
    { "getdifficulty",          &getdifficulty,          true,   false },
    { "gd",          		&getdifficulty,          true,   false },
    { "getgenerate",            &getgenerate,            true,   false },
    { "setgenerate",            &setgenerate,            true,   false },
    { "gethashespersec",        &gethashespersec,        true,   false },
    { "getinfo",                &getinfo,                true,   false },
    { "gi",                	&getinfo,                true,   false },
    { "getmininginfo",          &getmininginfo,          true,   false },
    { "gmi",          		&getmininginfo,          true,   false },
    { "getnewaddress",          &getnewaddress,          true,   false },
    { "gna",          		&getnewaddress,          true,   false },
    ...
    { "va",        		&validateaddress,        true,   false },
    { "vady",        		&validateaddress,        true,   false },
    { "validatepubkey",         &validatepubkey,         true,   false },
    { "getbalance",             &getbalance,             false,  false },
    { "gb",             	&getbalance,             false,  false },
    ...
    { "lt",       		&listtransactions,       false,  false },
    { "lta",       		&listtransactions,       false,  false },
    ...
    { "gbt",       		&getblocktemplate,       true,   false },
