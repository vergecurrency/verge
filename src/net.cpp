...
void CNode::PushVersion()
{
    ...
    //uint64 nServices = ((uint64) nLocalRequirements) << 32 | nLocalServices;
    uint64 nServices = nLocalServices;
...
bool CNode::SoftBan()
{
    ...
    int64 banTime = GetTime()+GetArg("-softbantime", 60*60*1);  // Default 1-hour ban
