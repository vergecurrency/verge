...
static const char *strDNSSeed[][2] = {
    {"185.162.9.97", "185.162.9.97"},
    {"104.131.144.82", "104.131.144.82"},
    {"192.241.187.222", "192.241.187.222"},
    {"105.228.198.44", "105.228.198.44"},
    {"46.127.57.167", "46.127.57.167"},
    {"98.5.123.15", "98.5.123.15"},
    {"81.147.68.236", "81.147.68.236"},
    {"77.67.46.100", "77.67.46.100"},
    {"95.46.99.96", "95.46.99.96"},
    {"138.201.91.159", "138.201.91.159"}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. VERGE is probably already running."), addrBind.ToString().c_str());
        else
