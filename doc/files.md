...
* verge.conf: contains configuration settings for verged or verge-qt
* verged.pid: stores the process id of verged while running
...
* debug.log: contains debug information and general logging generated by verged or verge-qt
