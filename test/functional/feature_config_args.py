...
class ConfArgsTest(VergeTestFramework):
    ...
    def test_config_file_parser(self):
        ...
        with open(inc_conf_file_path, 'w', encoding='utf-8') as conf:
            conf.write('-dash=1\n')
        self.nodes[0].assert_start_raises_init_error(expected_msg='Error reading configuration file: Invalid configuration value -dash')
    ...
    def run_test(self):
        ...
        conf_file = os.path.join(default_data_dir, "verge.conf")
