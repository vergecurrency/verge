...
"""Verify that starting verge with -h works as expected."""
import subprocess

from test_framework.test_framework import VergeTestFramework
from test_framework.util import assert_equal

class HelpTest(VergeTestFramework):
    ...
    def run_test(self):
        self.log.info("Start verge with -h for help text")
        ...
        self.log.info("Start verge with -version for version information")
        ...
        self.log.info("Start verged with -fakearg to make sure it does not start")
