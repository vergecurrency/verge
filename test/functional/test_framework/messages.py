...
# Copyright (c) 2010-2019 The Verge Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Verge test framework primitive and message structures
...
MY_VERSION = 90006  # past bip-31 for ping/pong
...
# Objects that map to verged objects, which can be serialized/deserialized
...
class CTransaction:
    ...
    def deserialize(self, f):
        ...
        if len(self.vin) == 0:
            ...
            # matches the implementation in verged
            if (flags != 0):
                self.vin = deser_vector(f, CTxIn)
...
class CBlockHeader:
    ...
    def serialize(self):
        ...
        r += ser_vector([], "serialize_without_witness")
        return r
...
class msg_headers:
    ...
    def deserialize(self, f):
        # comment in verged indicates these should be deserialized as blocks
