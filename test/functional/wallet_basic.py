...
class WalletTest(VergeTestFramework):
    ...
    def run_test(self):
        ...
        assert_equal(walletinfo['immature_balance'], 200000)
        ...
        assert_equal(txout['value'], 200000)
        ...
        # This will raise an exception for attempting to set a label for an invalid Verge address
        assert_raises_rpc_error(-5, "Invalid Verge address", self.nodes[0].setlabel, "invalid address", "label")

        # This will raise an exception for importing an invalid address
        assert_raises_rpc_error(-5, "Invalid Verge address or script", self.nodes[0].importaddress, "invalid")
        ...
        maintenance = [
            ...
            '-zapwallettxes=1',
            '-zapwallettxes=2',
            # disabled until issue is fixed: https://github.com/verge/verge/issues/7463
            # '-salvagewallet',
        ]
        chainlimit = 6
